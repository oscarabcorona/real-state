  ...
  const fetchPayments = async () => {
    try {
      ...
      setStats({
        ...
        autoPayActive:
          data?.filter((p) => p.payment_method === "ach").length || 0,
      });
    } catch (error) {
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`ml-2 h-4 w-4 transition-transform ${
                        isFilterModalOpen ? "transform rotate-180" : ""
                      }`}
                    />
                  </button>
                  <button
                        ...
                        <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                          ...
                          <div className="mt-4 flex-shrink-0 sm:mt-0">
                            <div className="flex items-center justify-between">
                              ...
                              <span
                                className={`ml-4 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusClass(
                                  payment.status
                                )}`}
                              >
                                {payment.status}
