            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <AnimatedElement animation="slideLeft" delay={0.2}>
                <div className="relative bg-white p-6 rounded-xl shadow-md">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    Our advanced AI analyzes market trends, tenant behavior, and
                    property performance to provide actionable insights.
                  </dd>
                </div>
              </AnimatedElement>
              ...
              <AnimatedElement animation="slideLeft" delay={0.4}>
                <div className="relative bg-white p-6 rounded-xl shadow-md">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    Bank-level encryption and advanced fraud detection keep your
                    data and transactions secure.
                  </dd>
                </div>
              </AnimatedElement>
              ...
              <AnimatedElement animation="slideLeft" delay={0.6}>
                <div className="relative bg-white p-6 rounded-xl shadow-md">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    AI-powered chatbot and human support team available around
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="logos-container grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
            <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <img
                className="h-12 company-logo opacity-0"
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              <AnimatedElement animation="slideUp" delay={0.2}>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    "The AI-powered insights have transformed how we manage
                    properties. We've seen a 40% increase in efficiency."
                  </p>
                </div>
              </AnimatedElement>
              ...
              <AnimatedElement animation="slideUp" delay={0.4}>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    "The automated compliance checks have saved us countless
                    hours and helped us avoid potential issues."
                  </p>
                </div>
              </AnimatedElement>
          ...
          <AnimatedElement animation="slideUp">
            <div className="lg:text-center mb-16">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                Experts in property management, technology, and customer
                service.
              </p>
            </div>
          </AnimatedElement>
            ...
            <dl className="space-y-6 divide-y divide-gray-200">
                ...
                <div className="pt-6">
                  ...
                  <dd className="mt-2 pr-12">
                    <p className="text-base text-gray-500">
                      Our AI system analyzes multiple data points including
                      credit history, background checks, and rental history to
                      provide comprehensive screening reports with 99% accuracy.
                    </p>
                  </dd>
                </div>
              </AnimatedElement>
              ...
              <AnimatedElement animation="slideLeft" delay={0.4}>
                <div className="pt-6">
                  ...
                  <dd className="mt-2 pr-12">
                    <p className="text-base text-gray-500">
                      We use bank-level encryption, two-factor authentication,
                      and regular security audits to ensure your data is always
                      protected.
                    </p>
                  </dd>
                </div>
              ...
              <AnimatedElement animation="slideLeft" delay={0.6}>
                <div className="pt-6">
                  ...
                  <dd className="mt-2 pr-12">
                    <p className="text-base text-gray-500">
                      Yes, our platform offers API integration with major
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8">
            <p className="text-base text-gray-400 text-center">
              © 2024 ShortStay Hub. All rights reserved. Powered by advanced AI
              technology.
            </p>
          </div>
        </div>
