            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="space-y-2">
                  {selectedReport.analysis.credit.factors.map(
                    (factor, index) => (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-xl font-bold">
                      ${selectedReport.analysis.income.annual.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">Monthly Income</div>
                    <div className="text-xl font-bold">
                      ${selectedReport.analysis.income.monthly.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="text-xl font-bold">
                      {selectedReport.analysis.income.employment_length}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-4">
                    ...
                    <ul className="space-y-2">
                      {selectedReport.analysis.background.recommendations.map(
                        (rec, index) => (
