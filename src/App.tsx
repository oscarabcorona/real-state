  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        >
          <Route index element={
            user?.role === 'tenant' ? <DashboardTenant /> : <DashboardLessor />
          } />
          <Route path="properties" element={<Properties />} />
          <Route path="marketplace" element={<Marketplace />} />
          <Route path="payments" element={user?.role === 'tenant' ? <PaymentTenant /> : <Payments />} />
          <Route path="documents" element={<Documents />} />
          <Route path="reports" element={<Reports />} />
          <Route path="appointments" element={user?.role === 'tenant' ? <AppointmentTenant /> : <Appointments />} />
